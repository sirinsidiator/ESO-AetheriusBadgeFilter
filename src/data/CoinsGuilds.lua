    ...
    {
        {
            ...
            badges = {
                ...
                {
                    name = "Council",
                    description = "Second only to the |cF3FF08Guildmaster|r.",
                    color = "F7F776"
                },
                {
                    name = "Doyen",
                    description = "Part of the ITT Alliance and former Officers/Leads",
                    color = "A1005B"
                },
                {
                    name = "Elder",
                ...
                {
                    name = "Eternal",
                    description = "Can only be kicked through inactivity!",
                    color = "2BDEAB"
                }
            }
        },
        {
            ...
            badges = {
                ...
                {
                    name = "Top Buyer",
                    description = "Has been one of the |cA9E2F33 Top-Buyers|r in one trading week. Can be awarded multiple times.",
                    color = "C46AFF",
                    limit = 999
                }
            }
